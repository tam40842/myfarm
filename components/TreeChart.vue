    ...
    <tr>
      ...
      >
        <div :class="{ node: true, hasMate: treeData.mate }">
          ...
          >
            <div class="avat">
              <v-img src="/dashboard/members/member-1.png"></v-img>
            </div>
            <div class="f1-wrapper">
              <span class="f1-counter">{{treeData.children.length}}</span>
            </div>
            <div class="name">
              {{ truncateAddress(treeData.name, "address") }}
            </div>
          </div>
...
.extend_handle:before {
  ...
  border: 4px solid;
  border-color: #882900 #882900 transparent transparent;
...
.childLevel:first-child:after {
  ...
  height: 15px;
  border: 2px solid;
  border-color: #882900 transparent transparent #882900;
...
.childLevel:first-child.childLevel:last-child::after {
  left: auto;
  border-radius: 0;
  border-color: transparent #882900 transparent transparent;
  transform: translate3d(1px, 0, 0);
}
.node {
  position: relative;
